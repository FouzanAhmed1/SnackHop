  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Welcome to SnackHop</h2>
          <p className="text-gray-700 mb-4">
            SnackHop is a platform designed to connect food lovers with their favorite restaurants. We aim to make dining out or ordering food from your favorite local spots easier, quicker, and more enjoyable.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700">
            Developed & Managed by SnackHop Pvt Ltd.
          </p>
        </div>
      </div>
    </div>
